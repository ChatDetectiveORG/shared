...
type UserSettings struct {
	ID           int           `pg:"id,pk,autoincrement,fk:telegram_users"`
	LinkedUserID []byte `pg:"linked_user_id,unique,notnull"`
	...
	ReferralBonusPreference    string `pg:"referral_bonus_preference,default:'levels'"`
}
